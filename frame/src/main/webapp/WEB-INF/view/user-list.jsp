...
<div class="pd-20">
  ...
  <div class="cl pd-5 bg-1 bk-gray mt-20">
    ...
    <a href="javascript:;" onclick="../hygl/goTj.do" class="btn btn-primary radius"><i class="icon-plus"></i> 添加用户</a></span>
